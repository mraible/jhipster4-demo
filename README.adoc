...
This article shows you how to build a simple blog application with https://jhipster.github.io/2017/03/01/jhipster-release-4.0.7.html[JHipster 4.0.7]. You can also [watch a video of this tutorial on YouTube](https://www.youtube.com/watch?v=XRREt1KB4Y8). 
