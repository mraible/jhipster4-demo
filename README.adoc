...
This article shows you how to build a simple blog application with http://www.jhipster.tech/2017/10/27/jhipster-release-4.10.2.html[JHipster 4.10.2]. You can also https://www.youtube.com/watch?v=XRREt1KB4Y8[watch a video of this tutorial on YouTube].
...
I ran `yo jhipster:heroku` as recommended in the http://www.jhipster.tech/heroku/[Deploying to Heroku] documentation. I used the name "`jhipster4-demo`" for my application when prompted.
